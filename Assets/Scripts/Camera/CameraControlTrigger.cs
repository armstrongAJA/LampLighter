...
public class MyScriptEditor : Editor//inherits from editor to control the custom inspector stuff
{
    ...
    public override void OnInspectorGUI()//basically a bunch of code just to add some fields in the inspector only if a box is checked
    {
